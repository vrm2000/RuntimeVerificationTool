...
public class parser extends java_cup.runtime.lr_parser {
	...
	protected static final short _production_table[][] = unpackFromStrings(
			new String[] { "\000\030\000\002\006\005\000\002\002\004\000\002\006"
					...
					+ "\000\002\004\003\000\002\004\003\000\002\005\003\000" + "\002\005\003\000\002\005\003" });
	...
	protected static final short[][] _action_table = unpackFromStrings(
			new String[] { "\000\052\000\012\010\005\011\012\012\011\014\010\001"
	...
	protected static final short[][] _reduce_table = unpackFromStrings(
			new String[] { "\000\052\000\012\005\006\006\012\007\003\010\005\001"
	...
	class CUP$parser$actions {
		...
		public final java_cup.runtime.Symbol CUP$parser$do_action_part00000000(int CUP$parser$act_num,
			...
			case 0: // expresion ::= expresion op_binario expresion
			{
				...
				int id1 = sc1.nextInt();
				int id2 = sc2.nextInt();
				Escritor_Fichero.escritor(opb + "  LEFT: " + id1 + " RIGHT: " + id2);
				valores.put(id, sc.nextLine() + " " + id1 + " " + id2);
				sc.close();
				sc1.close();
				sc2.close();
				RESULT = opb + " " + id1 + " " + id2;
				CUP$parser$result = parser.getSymbolFactory().newSymbol("expresion", 4,
			...
			case 2: // expresion ::= op_unario expresion
			{
				...
				int id = sc.nextInt();
				int id1 = sc1.nextInt();
				Escritor_Fichero.escritor(opu + "  LEFT: " + id1);
			...
			case 3: // expresion ::= op_unario phi
			{
				...
				Escritor_Fichero.escritor(id1 + "  " + res);
				valores.put(id, sc.nextLine() + " " + id1);
				valores.put(id1, res);
				sc.close();
				sc1.close();
			...
			case 5: // always ::= ALWAYS_ AC CHARTEXT COMA CHARTEXT CC
			{
				...
				RESULT = "2 " + ct1 + " " + ct2;
				CUP$parser$result = parser.getSymbolFactory().newSymbol("always", 5,
			...
			case 7: // eventually ::= EVENTUALLY_ AC CHARTEXT COMA CHARTEXT CC
			{
				...
				String ct2 = (String) ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 1)).value;
				RESULT = "2 " + ct1 + " " + ct2;
				CUP$parser$result = parser.getSymbolFactory().newSymbol("eventually", 6,
						((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 5)),
						((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
			}
				return CUP$parser$result;
			...
			case 9: // phi ::= CHARTEXT op NUM
			{
				...
				RESULT = id + " " + ct + " " + o + " " + valor;
				id++;
				CUP$parser$result = parser.getSymbolFactory().newSymbol("phi", 1,
						((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 2)),
						((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
			}
				return CUP$parser$result;
			...
			case 12: // op ::= MAYOR
			{
				String RESULT = null;
				RESULT = ">";
				CUP$parser$result = parser.getSymbolFactory().newSymbol("op", 0,
						((java_cup.runtime.Symbol) CUP$parser$stack.peek()),
						((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
			}
				return CUP$parser$result;
			...
			case 18: // op_binario ::= AND
			{
				...
				RESULT = id + " AND";
				id++;
				CUP$parser$result = parser.getSymbolFactory().newSymbol("op_binario", 2,
						((java_cup.runtime.Symbol) CUP$parser$stack.peek()),
						((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
			}
				return CUP$parser$result;
			...
			case 21: // op_unario ::= always
			{
				...
				RESULT = id + " Always_ " + al;
				id++;
				CUP$parser$result = parser.getSymbolFactory().newSymbol("op_unario", 3,
						((java_cup.runtime.Symbol) CUP$parser$stack.peek()),
						((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
			}
				return CUP$parser$result;
